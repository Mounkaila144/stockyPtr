...
/* harmony export */ });
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"main-content"},[_c('breadcumb',{attrs:{"page":_vm.$t('Currencies'),"folder":_vm.$t('Settings')}}),_vm._v(" "),(_vm.isLoading)?_c('div',{staticClass:"loading_page spinner spinner-primary mr-3"}):_vm._e(),_vm._v(" "),(!_vm.isLoading)?_c('b-card',{staticClass:"wrapper"},[_c('vue-good-table',{attrs:{"mode":"remote","columns":_vm.columns,"search-options":{
          enabled: true,
          placeholder:'search table'
        },"totalRows":_vm.totalRows,"rows":_vm.currencies,"select-options":{ 
        enabled: true ,
        clearSelectionText: '',
      },"pagination-options":{
      enabled: true,
      ...
      nextLabel: 'next',
      prevLabel: 'prev',
    },"styleClass":"table-hover tableOne vgt-table"},on:{"on-page-change":_vm.onPageChange,"on-per-page-change":_vm.onPerPageChange,"on-sort-change":_vm.onSortChange,"on-search":_vm.onSearch,"on-selected-rows-change":_vm.selectionChanged},scopedSlots:_vm._u([{key:"table-row",fn:function(props){return [(props.column.field == 'actions')?_c('span',[_c('a',{directives:[{name:"b-tooltip",rawName:"v-b-tooltip.hover",modifiers:{"hover":true}}],attrs:{"title":"Edit"},on:{"click":function($event){return _vm.Edit_Currency(props.row)}}},[_c('i',{staticClass:"i-Edit text-25 text-success"})]),_vm._v(" "),_c('a',{directives:[{name:"b-tooltip",rawName:"v-b-tooltip.hover",modifiers:{"hover":true}}],attrs:{"title":"Delete"},on:{"click":function($event){return _vm.Remove_Currency(props.row.id)}}},[_c('i',{staticClass:"i-Close-Window text-25 text-danger"})])]):_vm._e()]}}],null,false,604333498)},[_c('div',{attrs:{"slot":"selected-row-actions"},slot:"selected-row-actions"},[_c('button',{staticClass:"btn btn-danger btn-sm",on:{"click":function($event){return _vm.delete_by_selected()}}},[_vm._v(_vm._s(_vm.$t('Del')))])]),_vm._v(" "),_c('div',{staticClass:"mt-2 mb-3",attrs:{"slot":"table-actions"},slot:"table-actions"},[_c('b-button',{staticClass:"btn-rounded",attrs:{"variant":"btn btn-primary btn-icon m-1"},on:{"click":function($event){return _vm.New_Currency()}}},[_c('i',{staticClass:"i-Add"}),_vm._v("\n          "+_vm._s(_vm.$t('Add'))+"\n        ")])],1)])],1):_vm._e(),_vm._v(" "),_c('validation-observer',{ref:"Create_Currency"},[_c('b-modal',{attrs:{"hide-footer":"","size":"md","id":"New_Currency","title":_vm.editmode?_vm.$t('Edit'):_vm.$t('Add')}},[_c('b-form',{on:{"submit":function($event){$event.preventDefault();return _vm.Submit_Currency.apply(null, arguments)}}},[_c('b-row',[_c('b-col',{attrs:{"md":"12"}},[_c('validation-provider',{attrs:{"name":"Code Currency","rules":{ required: true , min:2 , max:5}},scopedSlots:_vm._u([{key:"default",fn:function(validationContext){return [_c('b-form-group',{attrs:{"label":_vm.$t('CurrencyCode') + ' ' + '*'}},[_c('b-form-input',{attrs:{"placeholder":_vm.$t('Enter_Code_Currency'),"state":_vm.getValidationState(validationContext),"aria-describedby":"Code-feedback","label":"Code"},model:{value:(_vm.currency.code),callback:function ($$v) {_vm.$set(_vm.currency, "code", $$v)},expression:"currency.code"}}),_vm._v(" "),_c('b-form-invalid-feedback',{attrs:{"id":"Code-feedback"}},[_vm._v(_vm._s(validationContext.errors[0]))])],1)]}}])})],1),_vm._v(" "),_c('b-col',{attrs:{"md":"12"}},[_c('validation-provider',{attrs:{"name":"Name Currency","rules":{ required: true , min:3}},scopedSlots:_vm._u([{key:"default",fn:function(validationContext){return [_c('b-form-group',{attrs:{"label":_vm.$t('CurrencyName') + ' ' + '*'}},[_c('b-form-input',{attrs:{"placeholder":_vm.$t('Enter_name_Currency'),"state":_vm.getValidationState(validationContext),"aria-describedby":"Name-feedback","label":"Name"},model:{value:(_vm.currency.name),callback:function ($$v) {_vm.$set(_vm.currency, "name", $$v)},expression:"currency.name"}}),_vm._v(" "),_c('b-form-invalid-feedback',{attrs:{"id":"Name-feedback"}},[_vm._v(_vm._s(validationContext.errors[0]))])],1)]}}])})],1),_vm._v(" "),_c('b-col',{attrs:{"md":"12"}},[_c('validation-provider',{attrs:{"name":"Symbole Currency","rules":{ required: true , max:5}},scopedSlots:_vm._u([{key:"default",fn:function(validationContext){return [_c('b-form-group',{attrs:{"label":_vm.$t('Symbol') + ' ' + '*'}},[_c('b-form-input',{attrs:{"placeholder":_vm.$t('Enter_Symbol_Currency'),"state":_vm.getValidationState(validationContext),"aria-describedby":"Symbole-feedback","label":"Symbole"},model:{value:(_vm.currency.symbol),callback:function ($$v) {_vm.$set(_vm.currency, "symbol", $$v)},expression:"currency.symbol"}}),_vm._v(" "),_c('b-form-invalid-feedback',{attrs:{"id":"Symbole-feedback"}},[_vm._v(_vm._s(validationContext.errors[0]))])],1)]}}])})],1),_vm._v(" "),_c('b-col',{staticClass:"mt-3",attrs:{"md":"12"}},[_c('b-button',{attrs:{"variant":"primary","type":"submit","disabled":_vm.SubmitProcessing}},[_c('i',{staticClass:"i-Yes me-2 font-weight-bold"}),_vm._v(" "+_vm._s(_vm.$t('submit')))]),_vm._v(" "),(_vm.SubmitProcessing)?_vm._m(0):_vm._e()],1)],1)],1)],1)],1)],1)}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_currencies_vue_vue_type_template_id_63a7628e__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_currencies_vue_vue_type_template_id_63a7628e__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_currencies_vue_vue_type_template_id_63a7628e__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./currencies.vue?vue&type=template&id=63a7628e */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/settings/currencies.vue?vue&type=template&id=63a7628e");
