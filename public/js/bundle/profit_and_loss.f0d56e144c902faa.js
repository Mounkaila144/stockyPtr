  ...
  methods: {
    ...
    get_data_loaded: function get_data_loaded() {
      ...
      if (self.today_mode) {
        ...
        self.startDate = formatDate(yesterday);
        self.endDate = formatDate(today);
        self.dateRange.startDate = formatDate(yesterday);
        self.dateRange.endDate = formatDate(today);
      }
    },
...
/* harmony export */ });
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"main-content"},[_c('breadcumb',{attrs:{"page":_vm.$t('ProfitandLoss'),"folder":_vm.$t('Reports')}}),_vm._v(" "),(_vm.isLoading)?_c('div',{staticClass:"loading_page spinner spinner-primary mr-3"}):_vm._e(),_vm._v(" "),(!_vm.isLoading)?_c('b-row',[_c('b-col',{staticClass:"text-center",attrs:{"md":"12"}},[_c('date-range-picker',{attrs:{"startDate":_vm.startDate,"endDate":_vm.endDate,"locale-data":_vm.locale},on:{"update":_vm.Submit_filter_dateRange},scopedSlots:_vm._u([{key:"input",fn:function(picker){return [_vm._v("\n            "+_vm._s(picker.startDate.toJSON().slice(0, 10))+" - "+_vm._s(picker.endDate.toJSON().slice(0, 10))+"\n        ")]}}],null,false,1941579395),model:{value:(_vm.dateRange),callback:function ($$v) {_vm.dateRange=$$v},expression:"dateRange"}})],1),_vm._v(" "),_c('b-col',{staticClass:"mt-4",attrs:{"md":"6"}},[_c('b-form-group',{attrs:{"label":_vm.$t('warehouse')}},[_c('v-select',{attrs:{"reduce":function (label) { return label.value; },"placeholder":_vm.$t('Choose_Warehouse'),"options":_vm.warehouses.map(function (warehouses) { return ({label: warehouses.name, value: warehouses.id}); })},on:{"input":_vm.Selected_Warehouse},model:{value:(_vm.warehouse_id),callback:function ($$v) {_vm.warehouse_id=$$v},expression:"warehouse_id"}})],1)],1),_vm._v(" "),_c('b-col',{staticClass:"mt-4",attrs:{"md":"12"}},[_c('b-row',[_c('b-col',{attrs:{"md":"4","sm":"12"}},[_c('div',{staticClass:"card card-icon text-center mb-30"},[_c('div',{staticClass:"card-body"},[_c('i',{staticClass:"i-Data-Upload"}),_vm._v(" "),_c('p',{staticClass:"text-muted mt-2 mb-2"},[_c('span',{staticClass:"bold"},[_vm._v("("+_vm._s(_vm.infos.sales_count)+")")]),_vm._v("\n                  "+_vm._s(_vm.$t('Sales'))+"\n                ")]),_vm._v(" "),_c('p',{staticClass:"text-primary text-24 line-height-1 m-0"},[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(_vm.infos.sales_sum))])])])]),_vm._v(" "),_c('b-col',{attrs:{"md":"4","sm":"12"}},[_c('div',{staticClass:"card card-icon text-center mb-30"},[_c('div',{staticClass:"card-body"},[_c('i',{staticClass:"i-Data-Upload"}),_vm._v(" "),_c('p',{staticClass:"text-muted mt-2 mb-2"},[_c('span',{staticClass:"bold"},[_vm._v("("+_vm._s(_vm.infos.purchases_count)+")")]),_vm._v("\n                  "+_vm._s(_vm.$t('Purchases'))+"\n                ")]),_vm._v(" "),_c('p',{staticClass:"text-primary text-24 line-height-1 m-0"},[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(_vm.infos.purchases_sum))])])])]),_vm._v(" "),_c('b-col',{attrs:{"md":"4","sm":"12"}},[_c('div',{staticClass:"card card-icon text-center mb-30"},[_c('div',{staticClass:"card-body"},[_c('i',{staticClass:"i-Data-Upload"}),_vm._v(" "),_c('p',{staticClass:"text-muted mt-2 mb-2"},[_c('span',{staticClass:"bold"},[_vm._v("("+_vm._s(_vm.infos.returns_sales_count)+")")]),_vm._v("\n                  "+_vm._s(_vm.$t('SalesReturn'))+"\n                ")]),_vm._v(" "),_c('p',{staticClass:"text-primary text-24 line-height-1 m-0"},[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(_vm.infos.returns_sales_sum))])])])]),_vm._v(" "),_c('b-col',{attrs:{"md":"4","sm":"12"}},[_c('div',{staticClass:"card card-icon text-center mb-30"},[_c('div',{staticClass:"card-body"},[_c('i',{staticClass:"i-Data-Upload"}),_vm._v(" "),_c('p',{staticClass:"text-muted mt-2 mb-2"},[_c('span',{staticClass:"bold"},[_vm._v("("+_vm._s(_vm.infos.returns_purchases_count)+")")]),_vm._v("\n                  "+_vm._s(_vm.$t('PurchasesReturn'))+"\n                ")]),_vm._v(" "),_c('p',{staticClass:"text-primary text-24 line-height-1 m-0"},[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(_vm.infos.returns_purchases_sum))])])])]),_vm._v(" "),_c('b-col',{attrs:{"md":"4","sm":"12"}},[_c('div',{staticClass:"card card-icon text-center mb-30"},[_c('div',{staticClass:"card-body"},[_c('i',{staticClass:"i-Data-Upload"}),_vm._v(" "),_c('p',{staticClass:"text-muted mt-2 mb-2"},[_c('span',{staticClass:"bold"},[_vm._v(_vm._s(_vm.$t('Expenses')))])]),_vm._v(" "),_c('p',{staticClass:"text-primary text-24 line-height-1 m-0"},[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(_vm.infos.expenses_sum))])])])]),_vm._v(" "),_c('b-col',{attrs:{"md":"4","sm":"12"}},[_c('div',{staticClass:"card card-icon text-center mb-30"},[_c('div',{staticClass:"card-body"},[_c('i',{staticClass:"i-Data-Upload"}),_vm._v(" "),_c('p',{staticClass:"text-muted mt-2 mb-2"},[_vm._v(_vm._s(_vm.$t('Revenue')))]),_vm._v(" "),_c('p',{staticClass:"text-primary text-24 line-height-1 m-0"},[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(_vm.infos.total_revenue))])]),_vm._v(" "),_c('div',{staticClass:"card-footer"},[_c('p',[_vm._v("\n                  (\n                  "),_c('span',{staticClass:"bold"},[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(_vm.infos.sales_sum))]),_vm._v("\n                  "+_vm._s(_vm.$t('Sales'))+")\n                  - (\n                  "),_c('span',{staticClass:"bold"},[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(_vm.infos.returns_sales_sum))]),_vm._v("\n                  "+_vm._s(_vm.$t('SalesReturn'))+")\n            \n                ")])])])]),_vm._v(" "),_c('b-col',{attrs:{"md":"4","sm":"12"}},[_c('div',{staticClass:"card card-icon text-center mb-30"},[_c('div',{staticClass:"card-body"},[_c('i',{staticClass:"i-Data-Upload"}),_vm._v(" "),_c('p',{staticClass:"text-muted mt-2 mb-2"},[_vm._v("Profit Net (Using FIFO METHOD)")]),_vm._v(" "),_c('p',{staticClass:"text-primary text-24 line-height-1 m-0"},[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(_vm.infos.profit_fifo))])]),_vm._v(" "),_c('div',{staticClass:"card-footer"},[_c('p',[_vm._v("\n                  (\n                  "),_c('span',{staticClass:"bold"},[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(_vm.infos.sales_sum))]),_vm._v("\n                  "+_vm._s(_vm.$t('Sales'))+")\n                  - (\n                  "),_c('span',{staticClass:"bold"},[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(_vm.infos.product_cost_fifo))]),_vm._v("\n                  "+_vm._s(_vm.$t('Product_Cost'))+")\n            \n                ")])])])]),_vm._v(" "),_c('b-col',{attrs:{"md":"4","sm":"12"}},[_c('div',{staticClass:"card card-icon text-center mb-30"},[_c('div',{staticClass:"card-body"},[_c('i',{staticClass:"i-Data-Upload"}),_vm._v(" "),_c('p',{staticClass:"text-muted mt-2 mb-2"},[_vm._v("Profit Net (Using Average Cost)")]),_vm._v(" "),_c('p',{staticClass:"text-primary text-24 line-height-1 m-0"},[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(_vm.infos.profit_average_cost))])]),_vm._v(" "),_c('div',{staticClass:"card-footer"},[_c('p',[_vm._v("\n                  (\n                  "),_c('span',{staticClass:"bold"},[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(_vm.infos.sales_sum))]),_vm._v("\n                  "+_vm._s(_vm.$t('Sales'))+")\n                  - (\n                  "),_c('span',{staticClass:"bold"},[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(_vm.infos.averagecost))]),_vm._v("\n                  "+_vm._s(_vm.$t('Product_Cost'))+")\n            \n                ")])])])]),_vm._v(" "),_c('b-col',{attrs:{"md":"4","sm":"12"}},[_c('div',{staticClass:"card card-icon text-center mb-30"},[_c('div',{staticClass:"card-body"},[_c('i',{staticClass:"i-Data-Upload"}),_vm._v(" "),_c('p',{staticClass:"text-muted mt-2 mb-2"},[_vm._v(_vm._s(_vm.$t('PaiementsReceived')))]),_vm._v(" "),_c('p',{staticClass:"text-primary text-24 line-height-1 m-0"},[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(_vm.infos.payment_received))])]),_vm._v(" "),_c('div',{staticClass:"card-footer"},[_c('p',[_vm._v("\n                  (\n                  "),_c('span',{staticClass:"bold"},[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(_vm.infos.paiement_sales))]),_vm._v("\n                  "+_vm._s(_vm.$t('PaymentsSales'))+"\n                  +\n                  "),_c('span',{staticClass:"bold"},[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(_vm.infos.PaymentPurchaseReturns))]),_vm._v("\n                  "+_vm._s(_vm.$t('PurchasesReturn'))+")\n                ")])])])]),_vm._v(" "),_c('b-col',{attrs:{"md":"4","sm":"12"}},[_c('div',{staticClass:"card card-icon text-center mb-30"},[_c('div',{staticClass:"card-body"},[_c('i',{staticClass:"i-Data-Upload"}),_vm._v(" "),_c('p',{staticClass:"text-muted mt-2 mb-2"},[_vm._v(_vm._s(_vm.$t('PaiementsSent')))]),_vm._v(" "),_c('p',{staticClass:"text-primary text-24 line-height-1 m-0"},[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(_vm.infos.payment_sent))])]),_vm._v(" "),_c('div',{staticClass:"card-footer"},[_c('p',[_vm._v("\n                  (\n                  "),_c('span',{staticClass:"bold"},[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(_vm.infos.paiement_purchases))]),_vm._v("\n                  "+_vm._s(_vm.$t('PaymentsPurchases'))+"\n                  +\n                  "),_c('span',{staticClass:"bold"},[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(_vm.infos.PaymentSaleReturns))]),_vm._v("\n                  "+_vm._s(_vm.$t('SalesReturn'))+")\n                  +\n                  "),_c('span',{staticClass:"bold"},[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(_vm.infos.expenses_sum))]),_vm._v("\n                  "+_vm._s(_vm.$t('Expenses'))+")\n                ")])])])]),_vm._v(" "),_c('b-col',{attrs:{"md":"4","sm":"12"}},[_c('div',{staticClass:"card card-icon text-center mb-30"},[_c('div',{staticClass:"card-body"},[_c('i',{staticClass:"i-Data-Upload"}),_vm._v(" "),_c('p',{staticClass:"text-muted mt-2 mb-2"},[_vm._v(_vm._s(_vm.$t('PaiementsNet')))]),_vm._v(" "),_c('p',{staticClass:"text-primary text-24 line-height-1 m-0"},[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(_vm.infos.paiement_net))])]),_vm._v(" "),_c('div',{staticClass:"card-footer"},[_c('p',[_vm._v("\n                  (\n                  "),_c('span',{staticClass:"bold"},[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(_vm.infos.payment_received))]),_vm._v("\n                  "+_vm._s(_vm.$t('Recieved'))+"\n                  -\n                  "),_c('span',{staticClass:"bold"},[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(_vm.infos.payment_sent))]),_vm._v("\n                  "+_vm._s(_vm.$t('Sent'))+")\n                ")])])])])],1)],1)],1):_vm._e()],1)}
var staticRenderFns = []
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_profit_and_loss_vue_vue_type_template_id_b6b30cee__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_profit_and_loss_vue_vue_type_template_id_b6b30cee__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
