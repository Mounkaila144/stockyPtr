...
/* harmony export */ });
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"main-content"},[_c('breadcumb',{attrs:{"page":_vm.$t('Attendances'),"folder":_vm.$t('hrm')}}),_vm._v(" "),(_vm.isLoading)?_c('div',{staticClass:"loading_page spinner spinner-primary mr-3"}):_vm._e(),_vm._v(" "),(!_vm.isLoading)?_c('b-card',{staticClass:"wrapper"},[_c('vue-good-table',{attrs:{"mode":"remote","columns":_vm.columns,"totalRows":_vm.totalRows,"rows":_vm.attendances,"search-options":{
      enabled: true,
      ...
      nextLabel: 'next',
      prevLabel: 'prev',
    },"styleClass":"table-hover tableOne vgt-table"},on:{"on-page-change":_vm.onPageChange,"on-per-page-change":_vm.onPerPageChange,"on-sort-change":_vm.onSortChange,"on-search":_vm.onSearch,"on-selected-rows-change":_vm.selectionChanged},scopedSlots:_vm._u([{key:"table-row",fn:function(props){return [(props.column.field == 'actions')?_c('span',[_c('a',{directives:[{name:"b-tooltip",rawName:"v-b-tooltip.hover",modifiers:{"hover":true}}],staticClass:"cursor-pointer",attrs:{"title":"Edit"},on:{"click":function($event){return _vm.Edit_Attendance(props.row)}}},[_c('i',{staticClass:"i-Edit text-25 text-success"})]),_vm._v(" "),_c('a',{directives:[{name:"b-tooltip",rawName:"v-b-tooltip.hover",modifiers:{"hover":true}}],staticClass:"cursor-pointer",attrs:{"title":"Delete"},on:{"click":function($event){return _vm.Remove_Attendance(props.row.id)}}},[_c('i',{staticClass:"i-Close-Window text-25 text-danger"})])]):_vm._e()]}}],null,false,1580272122)},[_c('div',{attrs:{"slot":"selected-row-actions"},slot:"selected-row-actions"},[_c('button',{staticClass:"btn btn-danger btn-sm",on:{"click":function($event){return _vm.delete_by_selected()}}},[_vm._v(_vm._s(_vm.$t('Del')))])]),_vm._v(" "),_c('div',{staticClass:"mt-2 mb-3",attrs:{"slot":"table-actions"},slot:"table-actions"},[_c('b-button',{staticClass:"btn-rounded",attrs:{"variant":"btn btn-primary btn-icon m-1"},on:{"click":function($event){return _vm.New_attendance()}}},[_c('i',{staticClass:"i-Add"}),_vm._v("\n          "+_vm._s(_vm.$t('Add'))+"\n        ")])],1)])],1):_vm._e(),_vm._v(" "),_c('validation-observer',{ref:"Create_Attendance"},[_c('b-modal',{attrs:{"hide-footer":"","size":"md","id":"Modal_attendance","title":_vm.editmode?_vm.$t('Edit'):_vm.$t('Add')}},[_c('b-form',{on:{"submit":function($event){$event.preventDefault();return _vm.Submit_Attendance.apply(null, arguments)}}},[_c('b-row',[_c('b-col',{attrs:{"md":"12"}},[_c('validation-provider',{attrs:{"name":"Company","rules":{ required: true}},scopedSlots:_vm._u([{key:"default",fn:function(ref){
    var valid = ref.valid;
    var errors = ref.errors;
return _c('b-form-group',{attrs:{"label":_vm.$t('Company') + ' ' + '*'}},[_c('v-select',{staticClass:"required",class:{'is-invalid': !!errors.length},attrs:{"state":errors[0] ? false : (valid ? true : null),"required":"","placeholder":_vm.$t('Choose_Company'),"reduce":function (label) { return label.value; },"options":_vm.companies.map(function (companies) { return ({label: companies.name, value: companies.id}); })},on:{"input":_vm.Selected_Company},model:{value:(_vm.attendance.company_id),callback:function ($$v) {_vm.$set(_vm.attendance, "company_id", $$v)},expression:"attendance.company_id"}}),_vm._v(" "),_c('b-form-invalid-feedback',[_vm._v(_vm._s(errors[0]))])],1)}}])})],1),_vm._v(" "),_c('b-col',{attrs:{"md":"12"}},[_c('validation-provider',{attrs:{"name":"Employee","rules":{ required: true}},scopedSlots:_vm._u([{key:"default",fn:function(ref){
    var valid = ref.valid;
    var errors = ref.errors;
return _c('b-form-group',{attrs:{"label":_vm.$t('Employee') + ' ' + '*'}},[_c('v-select',{staticClass:"required",class:{'is-invalid': !!errors.length},attrs:{"state":errors[0] ? false : (valid ? true : null),"required":"","placeholder":_vm.$t('Choose_Employee'),"reduce":function (label) { return label.value; },"options":_vm.employees.map(function (employees) { return ({label: employees.username, value: employees.id}); })},on:{"input":_vm.Selected_Employee},model:{value:(_vm.attendance.employee_id),callback:function ($$v) {_vm.$set(_vm.attendance, "employee_id", $$v)},expression:"attendance.employee_id"}}),_vm._v(" "),_c('b-form-invalid-feedback',[_vm._v(_vm._s(errors[0]))])],1)}}])})],1),_vm._v(" "),_c('b-col',{attrs:{"md":"12"}},[_c('validation-provider',{attrs:{"name":"Date","rules":{ required: true}},scopedSlots:_vm._u([{key:"default",fn:function(ref){
    var valid = ref.valid;
    var errors = ref.errors;
return _c('b-form-group',{attrs:{"label":_vm.$t('date') + ' ' + '*'}},[_c('Datepicker',{attrs:{"id":"date","name":"date","placeholder":_vm.$t('Enter_Attendance_date'),"input-class":"form-control back_important","format":"yyyy-MM-dd"},on:{"closed":function($event){_vm.attendance.date=_vm.formatDate(_vm.attendance.date)}},model:{value:(_vm.attendance.date),callback:function ($$v) {_vm.$set(_vm.attendance, "date", $$v)},expression:"attendance.date"}}),_vm._v(" "),_c('b-form-invalid-feedback',[_vm._v(_vm._s(errors[0]))])],1)}}])})],1),_vm._v(" "),_c('b-col',{attrs:{"md":"12"}},[_c('validation-provider',{attrs:{"name":"Time_In","rules":{ required: true}},scopedSlots:_vm._u([{key:"default",fn:function(ref){
    var valid = ref.valid;
    var errors = ref.errors;
return _c('b-form-group',{attrs:{"label":_vm.$t('Time_In') + ' ' + '*'}},[_c('vue-clock-picker',{attrs:{"placeholder":_vm.$t('Time_In'),"name":"clock_in","id":"clock_in"},model:{value:(_vm.attendance.clock_in),callback:function ($$v) {_vm.$set(_vm.attendance, "clock_in", $$v)},expression:"attendance.clock_in"}}),_vm._v(" "),_c('b-form-invalid-feedback',[_vm._v(_vm._s(errors[0]))])],1)}}])})],1),_vm._v(" "),_c('b-col',{attrs:{"md":"12"}},[_c('validation-provider',{attrs:{"name":"Time_Out","rules":{ required: true}},scopedSlots:_vm._u([{key:"default",fn:function(ref){
    var valid = ref.valid;
    var errors = ref.errors;
return _c('b-form-group',{attrs:{"label":_vm.$t('Time_Out') + ' ' + '*'}},[_c('vue-clock-picker',{attrs:{"placeholder":_vm.$t('Time_Out'),"name":"clock_out","id":"clock_out"},model:{value:(_vm.attendance.clock_out),callback:function ($$v) {_vm.$set(_vm.attendance, "clock_out", $$v)},expression:"attendance.clock_out"}}),_vm._v(" "),_c('b-form-invalid-feedback',[_vm._v(_vm._s(errors[0]))])],1)}}])})],1),_vm._v(" "),_c('b-col',{staticClass:"mt-3",attrs:{"md":"12"}},[_c('b-button',{attrs:{"variant":"primary","type":"submit","disabled":_vm.SubmitProcessing}},[_c('i',{staticClass:"i-Yes me-2 font-weight-bold"}),_vm._v(" "+_vm._s(_vm.$t('submit')))]),_vm._v(" "),(_vm.SubmitProcessing)?_vm._m(0):_vm._e()],1)],1)],1)],1)],1)],1)}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_attendance_vue_vue_type_template_id_561c991c__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_attendance_vue_vue_type_template_id_561c991c__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_attendance_vue_vue_type_template_id_561c991c__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./attendance.vue?vue&type=template&id=561c991c */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/hrm/attendance.vue?vue&type=template&id=561c991c");
