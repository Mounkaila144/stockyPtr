...
/* harmony export */ });
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"main-content"},[_c('breadcumb',{attrs:{"page":_vm.$t('Printbarcode'),"folder":_vm.$t('Products')}}),_vm._v(" "),(_vm.isLoading)?_c('div',{staticClass:"loading_page spinner spinner-primary mr-3"}):_vm._e(),_vm._v(" "),(!_vm.isLoading)?_c('b-row',[_c('b-modal',{attrs:{"hide-footer":"","id":"open_scan","size":"md","title":"Barcode Scanner"}},[_c('qrcode-scanner',{staticStyle:{"width":"100%","height":"calc(100vh - 56px)"},attrs:{"qrbox":250,"fps":10},on:{"result":_vm.onScan}})],1),_vm._v(" "),_c('b-col',{staticClass:"mb-3",attrs:{"md":"6"}},[_c('validation-observer',{ref:"show_Barcode"},[_c('validation-provider',{attrs:{"name":"warehouse","rules":{ required: true}},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var valid = ref.valid;
var errors = ref.errors;
return _c('b-form-group',{attrs:{"label":_vm.$t('warehouse') + ' ' + '*'}},[_c('v-select',{class:{'is-invalid': !!errors.length},attrs:{"state":errors[0] ? false : (valid ? true : null),"reduce":function (label) { return label.value; },"placeholder":_vm.$t('Choose_Warehouse'),"options":_vm.warehouses.map(function (warehouses) { return ({label: warehouses.name, value: warehouses.id}); })},on:{"input":_vm.Selected_Warehouse},model:{value:(_vm.barcode.warehouse_id),callback:function ($$v) {_vm.$set(_vm.barcode, "warehouse_id", $$v)},expression:"barcode.warehouse_id"}}),_vm._v(" "),_c('b-form-invalid-feedback',[_vm._v(_vm._s(errors[0]))])],1)}}],null,false,399681630)})],1)],1),_vm._v(" "),_c('b-col',{staticClass:"mb-5",attrs:{"md":"12"}},[_c('h6',[_vm._v(_vm._s(_vm.$t('ProductName')))]),_vm._v(" "),_c('div',{staticClass:"autocomplete",attrs:{"id":"autocomplete"}},[_c('div',{staticClass:"input-with-icon"},[_c('img',{staticClass:"scan-icon",attrs:{"src":"/assets_setup/scan.png","alt":"Scan"},on:{"click":_vm.showModal}}),_vm._v(" "),_c('input',{ref:"product_autocomplete",staticClass:"autocomplete-input",attrs:{"placeholder":_vm.$t('Scan_Search_Product_by_Code_Name')},on:{"input":function (e) { return _vm.search_input = e.target.value; },"keyup":function($event){return _vm.search(_vm.search_input)},"focus":_vm.handleFocus,"blur":_vm.handleBlur}})]),_vm._v(" "),_c('ul',{directives:[{name:"show",rawName:"v-show",value:(_vm.focused),expression:"focused"}],staticClass:"autocomplete-result-list"},_vm._l((_vm.product_filter),function(product_fil){return _c('li',{staticClass:"autocomplete-result",on:{"mousedown":function($event){return _vm.SearchProduct(product_fil)}}},[_vm._v(_vm._s(_vm.getResultValue(product_fil)))])}),0)])]),_vm._v(" "),_c('b-col',{attrs:{"md":"12"}},[_c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"table table-hover table-md"},[_c('thead',[_c('tr',[_c('th',{attrs:{"scope":"col"}},[_vm._v(_vm._s(_vm.$t('ProductName')))]),_vm._v(" "),_c('th',{attrs:{"scope":"col"}},[_vm._v(_vm._s(_vm.$t('CodeProduct')))]),_vm._v(" "),_c('th',{attrs:{"scope":"col"}},[_vm._v(_vm._s(_vm.$t('Quantity')))]),_vm._v(" "),_c('th',{staticClass:"text-center",attrs:{"scope":"col"}},[_c('i',{staticClass:"fa fa-trash"})])])]),_vm._v(" "),_c('tbody',[(_vm.products_added.length === 0)?_c('tr',[_c('td',{attrs:{"colspan":"4"}},[_vm._v(_vm._s(_vm.$t('NodataAvailable')))])]):_vm._e(),_vm._v(" "),_vm._l((_vm.products_added),function(product){return _c('tr',{key:product.code},[_c('td',[_vm._v(_vm._s(product.name))]),_vm._v(" "),_c('td',[_vm._v(_vm._s(product.code))]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model.number",value:(product.qte),expression:"product.qte",modifiers:{"number":true}}],staticClass:"form-control w-50 h-25",attrs:{"id":"qte","type":"number","name":"qte"},domProps:{"value":(product.qte)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(product, "qte", _vm._n($event.target.value))},"blur":function($event){return _vm.$forceUpdate()}}})]),_vm._v(" "),_c('td',[_c('i',{staticClass:"i-Close-Window text-25 text-danger",on:{"click":function($event){return _vm.delete_Product(product.code)}}})])])})],2)])])]),_vm._v(" "),_c('b-col',{attrs:{"md":"12"}},[_c('b-form-group',{attrs:{"label":_vm.$t('Paper_size')}},[_c('v-select',{attrs:{"reduce":function (label) { return label.value; },"placeholder":_vm.$t('Paper_size'),"options":[
                      ...
                      {label: 'Stickers', value: 'customstyle'} ]},on:{"input":_vm.Selected_Paper_size},model:{value:(_vm.paper_size),callback:function ($$v) {_vm.paper_size=$$v},expression:"paper_size"}})],1)],1),_vm._v(" "),_c('b-col',{staticClass:"mt-4",attrs:{"md":"6"}},[_c('label',{staticClass:"checkbox checkbox-primary mb-3"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.show_price),expression:"show_price"}],attrs:{"type":"checkbox"},domProps:{"checked":Array.isArray(_vm.show_price)?_vm._i(_vm.show_price,null)>-1:(_vm.show_price)},on:{"change":function($event){var $$a=_vm.show_price,$$el=$event.target,$$c=$$el.checked?(true):(false);if(Array.isArray($$a)){var $$v=null,$$i=_vm._i($$a,$$v);if($$el.checked){$$i<0&&(_vm.show_price=$$a.concat([$$v]))}else{$$i>-1&&(_vm.show_price=$$a.slice(0,$$i).concat($$a.slice($$i+1)))}}else{_vm.show_price=$$c}}}}),_c('h5',[_vm._v("Display Price ")]),_c('span',{staticClass:"checkmark"})])]),_vm._v(" "),_c('b-col',{staticClass:"mt-4",attrs:{"md":"12"}},[_c('button',{staticClass:"btn btn-primary btn-sm m-1",attrs:{"type":"submit"},on:{"click":function($event){return _vm.submit()}}},[_c('i',{staticClass:"i-Edit"}),_vm._v("\n          "+_vm._s(_vm.$t('Updat'))+"\n        ")]),_vm._v(" "),_c('button',{staticClass:"btn btn-danger btn-sm m-1",attrs:{"type":"submit"},on:{"click":function($event){return _vm.reset()}}},[_c('i',{staticClass:"i-Power-2"}),_vm._v("\n          "+_vm._s(_vm.$t('Reset'))+"\n        ")]),_vm._v(" "),_c('button',{staticClass:"btn btn-light btn-sm pull-right m-1",attrs:{"value":"Print","type":"submit"},on:{"click":function($event){return _vm.print_all_Barcode()}}},[_c('i',{staticClass:"i-Billing"}),_vm._v("\n          "+_vm._s(_vm.$t('print'))+"\n        ")])]),_vm._v(" "),_c('b-col',{attrs:{"md":"12"}},[(_vm.ShowCard)?_c('div',{staticClass:"barcode-row",attrs:{"id":"print_barcode_label"}},_vm._l((_vm.pages),function(page,pageIndex){return _c('div',{key:pageIndex},[_c('div',{class:_vm.class_type_page},_vm._l((page),function(barcode,index){return _c('div',{key:index,staticClass:"barcode-item",class:_vm.class_sheet},[_c('div',{staticClass:"head_barcode text-left",staticStyle:{"padding-left":"10px","font-weight":"bold","font-size":"10px"}},[_c('span',{staticClass:"barcode-name"},[_vm._v(_vm._s(barcode.name))]),_vm._v(" "),(_vm.show_price)?_c('span',{staticClass:"barcode-price"},[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(barcode.Net_price))]):_vm._e()]),_vm._v(" "),_c('barcode',{staticClass:"barcode",attrs:{"format":barcode.Type_barcode,"value":barcode.barcode,"textmargin":"0","fontoptions":"bold","fontSize":"15","height":"25","width":"1"}})],1)}),0)])}),0):_vm._e()])],1):_vm._e()],1)}
var staticRenderFns = []
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_barcode_vue_vue_type_template_id_3a52cd32__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_barcode_vue_vue_type_template_id_3a52cd32__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
