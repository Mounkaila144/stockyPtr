...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            ...
            case 1:
              _yield$_this$$refs$Im = _context.v;
    ...
    setDefaultValues: function setDefaultValues() {
      // Set default category only if empty
      if (this.categories.length > 0 && (!this.product.category_id || this.product.category_id === "")) {
        this.product.category_id = this.categories[0].id;
      }

      // Set default brand only if empty
      if (this.brands.length > 0 && (!this.product.brand_id || this.product.brand_id === "")) {
        this.product.brand_id = this.brands[0].id;
      }

      // Set default unit only if empty
      if (this.units.length > 0 && (!this.product.unit_id || this.product.unit_id === "")) {
        this.product.unit_id = this.units[0].id;
        // Load sub units for the selected unit
        this.Selected_Unit(this.product.unit_id);
      } else if (this.product.unit_id) {
        // If unit exists, load its sub units and set defaults for sale/purchase if empty
        this.Selected_Unit(this.product.unit_id);
      }
    },
    //------------- Set Default Sale and Purchase Units (called after sub units are loaded)
    setDefaultSubUnits: function setDefaultSubUnits() {
      // Set default sale unit only if empty
      if (this.units_sub.length > 0 && (!this.product.unit_sale_id || this.product.unit_sale_id === "")) {
        this.product.unit_sale_id = this.units_sub[0].id;
      }

      // Set default purchase unit only if empty
      if (this.units_sub.length > 0 && (!this.product.unit_purchase_id || this.product.unit_purchase_id === "")) {
    ...
    Get_Units_SubBase: function Get_Units_SubBase(value) {
      ...
      axios.get("get_sub_units_by_base?id=" + value).then(function (_ref3) {
        ...
        // Set default sub units after loading (only for empty fields)
        _this6.setDefaultSubUnits();
      });
    },
    ...
    //--------------------------- reset Category Form ----------------\\
    reset_Category_Form: function reset_Category_Form() {
      this.newCategory = {
        name: "",
        code: ""
      };
    ...
    Create_Category: function Create_Category() {
      ...
      axios.post("categories", {
        ...
        _this9.CategorySubmitProcessing = false;
        // Ajouter la nouvelle catégorie à la liste locale
        var newCat = {
          id: response.data.id || Date.now(),
          // Utiliser un ID temporaire si non fourni
          name: _this9.newCategory.name,
          code: _this9.newCategory.code
        };
        _this9.categories.push(newCat);

        // Sélectionner automatiquement la nouvelle catégorie
        _this9.product.category_id = newCat.id;
    ...
    //--------------------------- reset Unit Form ----------------\\
    reset_Unit_Form: function reset_Unit_Form() {
      this.newUnit = {
        name: "",
        ShortName: "",
        base_unit: "",
    ...
    Create_Unit: function Create_Unit() {
      ...
      var base_unit = this.newUnit.base_unit;
      var operator = this.newUnit.operator;
      var operator_value = this.newUnit.operator_value;
      ...
      axios.post("units", {
        ...
        _this1.UnitSubmitProcessing = false;
        // Ajouter la nouvelle unité à la liste locale
        var newUnitData = {
          id: response.data.id || Date.now(),
          // Utiliser un ID temporaire si non fourni
          name: _this1.newUnit.name,
          ShortName: _this1.newUnit.ShortName
        };
        _this1.units.push(newUnitData);

        // Sélectionner automatiquement la nouvelle unité
        _this1.product.unit_id = newUnitData.id;

        // Mettre à jour les unités de vente et d'achat
        _this1.Selected_Unit(newUnitData.id);

        // Fermer la modal
        _this1.$bvModal.hide("New_Unit");
    ...
    //---------------------- Get Units Base ------------------------------\\
    Get_Units_Base: function Get_Units_Base() {
      var _this10 = this;
      axios.get("units").then(function (response) {
        _this10.units_base = response.data.Units_base;
      })["catch"](function (error) {
        console.log(error);
      });
    }
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/products/Edit_product.vue?vue&type=template&id=379e8f98":
/*!**************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/products/Edit_product.vue?vue&type=template&id=379e8f98 ***!
  \**************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"main-content"},[_c('breadcumb',{attrs:{"page":'Update Product',"folder":_vm.$t('Products')}}),_vm._v(" "),(_vm.isLoading)?_c('div',{staticClass:"loading_page spinner spinner-primary mr-3"}):_vm._e(),_vm._v(" "),(!_vm.isLoading)?_c('validation-observer',{ref:"Edit_Product"},[_c('b-form',{attrs:{"enctype":"multipart/form-data"},on:{"submit":function($event){$event.preventDefault();return _vm.Submit_Product.apply(null, arguments)}}},[_c('b-row',[_c('b-col',{staticClass:"mb-2",attrs:{"md":"8"}},[_c('b-card',{staticClass:"mt-3"},[_c('b-row',[_c('b-col',{staticClass:"mb-2",attrs:{"md":"6"}},[_c('validation-provider',{attrs:{"name":"Name","rules":{required:true , min:3 , max:55}},scopedSlots:_vm._u([{key:"default",fn:function(validationContext){return [_c('b-form-group',{attrs:{"label":_vm.$t('Name_product') + ' ' + '*'}},[_c('b-form-input',{attrs:{"state":_vm.getValidationState(validationContext),"aria-describedby":"Name-feedback","label":"Name","placeholder":_vm.$t('Enter_Name_Product')},model:{value:(_vm.product.name),callback:function ($$v) {_vm.$set(_vm.product, "name", $$v)},expression:"product.name"}}),_vm._v(" "),_c('b-form-invalid-feedback',{attrs:{"id":"Name-feedback"}},[_vm._v(_vm._s(validationContext.errors[0]))])],1)]}}],null,false,1186898396)})],1),_vm._v(" "),_c('b-col',{staticClass:"mb-2",attrs:{"md":"6"}},[_c('validation-provider',{ref:"Image",attrs:{"name":"Image","rules":"mimes:image/*"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var validate = ref.validate;
var valid = ref.valid;
var errors = ref.errors;
return _c('b-form-group',{attrs:{"label":"Product Image"}},[_c('input',{class:{'is-invalid': !!errors.length},attrs:{"state":errors[0] ? false : (valid ? true : null),"label":"Choose Image","type":"file"},on:{"change":_vm.onFileSelected}}),_vm._v(" "),_c('b-form-invalid-feedback',{attrs:{"id":"Image-feedback"}},[_vm._v(_vm._s(errors[0]))])],1)}}],null,false,2323855258)})],1),_vm._v(" "),_c('b-col',{staticClass:"mb-2 d-none",attrs:{"md":"6"}},[_c('validation-provider',{attrs:{"name":"Barcode Symbology","rules":{ required: true}},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var valid = ref.valid;
var errors = ref.errors;
return _c('b-form-group',{attrs:{"label":_vm.$t('BarcodeSymbology') + ' ' + '*'}},[_c('v-select',{class:{'is-invalid': !!errors.length},attrs:{"state":errors[0] ? false : (valid ? true : null),"reduce":function (label) { return label.value; },"placeholder":_vm.$t('Choose_Symbology'),"options":[
                            ...
                            {label: 'UPC', value: 'UPC'} ]},model:{value:(_vm.product.Type_barcode),callback:function ($$v) {_vm.$set(_vm.product, "Type_barcode", $$v)},expression:"product.Type_barcode"}}),_vm._v(" "),_c('b-form-invalid-feedback',[_vm._v(_vm._s(errors[0]))])],1)}}],null,false,749236710)})],1),_vm._v(" "),_c('b-col',{staticClass:"mb-2 d-none",attrs:{"md":"6"}},[_c('validation-provider',{attrs:{"name":"Code Product","rules":{ required: true}},scopedSlots:_vm._u([{key:"default",fn:function(ref){
                          var valid = ref.valid;
                          var errors = ref.errors;
return _c('b-form-group',{attrs:{"label":_vm.$t('CodeProduct') + ' ' + '*'}},[_c('b-form-input',{class:{'is-invalid': !!errors.length},attrs:{"state":errors[0] ? false : (valid ? true : null),"aria-describedby":"CodeProduct-feedback","type":"text"},model:{value:(_vm.product.code),callback:function ($$v) {_vm.$set(_vm.product, "code", $$v)},expression:"product.code"}}),_vm._v(" "),_c('b-form-invalid-feedback',{attrs:{"id":"CodeProduct-feedback"}},[_vm._v(_vm._s(errors[0]))])],1)}}],null,false,619388006)})],1),_vm._v(" "),_c('b-col',{staticClass:"mb-2",attrs:{"md":"6"}},[_c('validation-provider',{attrs:{"name":"category","rules":{ required: true}},scopedSlots:_vm._u([{key:"default",fn:function(ref){
                          var valid = ref.valid;
                          var errors = ref.errors;
return _c('b-form-group',{attrs:{"label":_vm.$t('Categorie') + ' ' + '*'}},[_c('div',{staticClass:"d-flex"},[_c('v-select',{class:{'is-invalid': !!errors.length},staticStyle:{"flex":"1"},attrs:{"state":errors[0] ? false : (valid ? true : null),"reduce":function (label) { return label.value; },"placeholder":_vm.$t('Choose_Category'),"options":_vm.categories.map(function (categories) { return ({label: categories.name, value: categories.id}); })},model:{value:(_vm.product.category_id),callback:function ($$v) {_vm.$set(_vm.product, "category_id", $$v)},expression:"product.category_id"}}),_vm._v(" "),_c('b-button',{staticClass:"ml-2",staticStyle:{"height":"38px","min-width":"40px"},attrs:{"variant":"primary","size":"sm","title":"Ajouter une nouvelle catégorie"},on:{"click":function($event){return _vm.New_Category()}}},[_c('i',{staticClass:"i-Add"})])],1),_vm._v(" "),_c('b-form-invalid-feedback',[_vm._v(_vm._s(errors[0]))])],1)}}],null,false,267941755)})],1),_vm._v(" "),_c('b-col',{staticClass:"mb-2",attrs:{"md":"6"}},[_c('b-form-group',{attrs:{"label":_vm.$t('Brand')}},[_c('v-select',{attrs:{"placeholder":_vm.$t('Choose_Brand'),"reduce":function (label) { return label.value; },"options":_vm.brands.map(function (brands) { return ({label: brands.name, value: brands.id}); })},model:{value:(_vm.product.brand_id),callback:function ($$v) {_vm.$set(_vm.product, "brand_id", $$v)},expression:"product.brand_id"}})],1)],1),_vm._v(" "),_c('b-col',{staticClass:"mb-2",attrs:{"md":"6"}},[_c('validation-provider',{attrs:{"name":"Order Tax","rules":{regex: /^\d*\.?\d*$/}},scopedSlots:_vm._u([{key:"default",fn:function(validationContext){return [_c('b-form-group',{attrs:{"label":_vm.$t('OrderTax')}},[_c('div',{staticClass:"input-group"},[_c('input',{directives:[{name:"model",rawName:"v-model.number",value:(_vm.product.TaxNet),expression:"product.TaxNet",modifiers:{"number":true}}],staticClass:"form-control",attrs:{"state":_vm.getValidationState(validationContext),"aria-describedby":"OrderTax-feedback","type":"text"},domProps:{"value":(_vm.product.TaxNet)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.product, "TaxNet", _vm._n($event.target.value))},"blur":function($event){return _vm.$forceUpdate()}}}),_vm._v(" "),_c('div',{staticClass:"input-group-append"},[_c('span',{staticClass:"input-group-text"},[_vm._v("%")])])]),_vm._v(" "),_c('b-form-invalid-feedback',{attrs:{"id":"OrderTax-feedback"}},[_vm._v(_vm._s(validationContext.errors[0]))])],1)]}}],null,false,1338089657)})],1),_vm._v(" "),_c('b-col',{staticClass:"mb-2",attrs:{"lg":"6","md":"6","sm":"12"}},[_c('validation-provider',{attrs:{"name":"Tax Method","rules":{ required: true}},scopedSlots:_vm._u([{key:"default",fn:function(ref){
                          var valid = ref.valid;
                          var errors = ref.errors;
return _c('b-form-group',{attrs:{"label":_vm.$t('TaxMethod') + ' ' + '*'}},[_c('v-select',{class:{'is-invalid': !!errors.length},attrs:{"state":errors[0] ? false : (valid ? true : null),"reduce":function (label) { return label.value; },"placeholder":_vm.$t('Choose_Method'),"options":[
                         ...
                         ]},model:{value:(_vm.product.tax_method),callback:function ($$v) {_vm.$set(_vm.product, "tax_method", $$v)},expression:"product.tax_method"}}),_vm._v(" "),_c('b-form-invalid-feedback',[_vm._v(_vm._s(errors[0]))])],1)}}],null,false,1240149397)})],1),_vm._v(" "),_c('b-col',{staticClass:"mb-2",attrs:{"md":"12"}},[_c('b-form-group',{attrs:{"label":_vm.$t('Description')}},[_c('textarea',{directives:[{name:"model",rawName:"v-model",value:(_vm.product.note),expression:"product.note"}],staticClass:"form-control",attrs:{"rows":"4","placeholder":_vm.$t('Afewwords')},domProps:{"value":(_vm.product.note)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.product, "note", $event.target.value)}}})])],1)],1)],1),_vm._v(" "),(_vm.product.type == 'is_combo')?_c('b-card',{staticClass:"mt-3"},[_c('b-row',[_c('div',{staticClass:"col-md-12 mb-5 mt-3"},[_c('div',{staticClass:"autocomplete",attrs:{"id":"autocomplete"}},[_c('input',{ref:"product_autocomplete",staticClass:"autocomplete-input",attrs:{"placeholder":_vm.$t('Scan_Search_Product_by_Code_Name')},on:{"input":function (e) { return _vm.search_input = e.target.value; },"keyup":function($event){return _vm.search(_vm.search_input)},"focus":_vm.handleFocus,"blur":_vm.handleBlur}}),_vm._v(" "),_c('ul',{directives:[{name:"show",rawName:"v-show",value:(_vm.focused),expression:"focused"}],staticClass:"autocomplete-result-list"},_vm._l((_vm.product_filter),function(product_fil){return _c('li',{staticClass:"autocomplete-result",on:{"mousedown":function($event){return _vm.SearchProduct(product_fil)}}},[_vm._v(_vm._s(_vm.getResultValue(product_fil)))])}),0)])]),_vm._v(" "),_c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"table table-hover table-sm"},[_c('thead',{staticClass:"bg-gray-300"},[_c('tr',[_c('th',{attrs:{"scope":"col"}},[_vm._v("Product Name")]),_vm._v(" "),_c('th',{attrs:{"scope":"col"}},[_vm._v("Quantity")]),_vm._v(" "),_c('th',{staticClass:"text-right",attrs:{"scope":"col"}},[_vm._v("Cost")]),_vm._v(" "),_c('th',{staticClass:"text-right",attrs:{"scope":"col"}},[_vm._v("SubTotal")]),_vm._v(" "),_c('th',{staticClass:"text-right",attrs:{"scope":"col"}})])]),_vm._v(" "),_c('tbody',[(_vm.materiels.length <=0)?_c('tr',[_c('td',{attrs:{"colspan":"4"}},[_vm._v("No data Available")])]):_vm._e(),_vm._v(" "),_vm._l((_vm.materiels),function(materiel){return _c('tr',[_c('td',[_c('span',{staticClass:"badge badge-success"},[_vm._v(_vm._s(materiel.name))]),_vm._v(" "),_c('br'),_vm._v(" "),_c('span',[_vm._v(_vm._s(materiel.code))])]),_vm._v(" "),_c('td',[_c('div',{staticClass:"input-group"},[_c('input',{directives:[{name:"model",rawName:"v-model.number",value:(materiel.quantity),expression:"materiel.quantity",modifiers:{"number":true}}],staticClass:"form-control",staticStyle:{"width":"30px"},domProps:{"value":(materiel.quantity)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(materiel, "quantity", _vm._n($event.target.value))},"blur":function($event){return _vm.$forceUpdate()}}}),_vm._v(" "),_c('div',{staticClass:"input-group-append"},[_c('span',{staticClass:"input-group-text"},[_vm._v(_vm._s(materiel.unit_name))])])])]),_vm._v(" "),_c('td',{staticClass:"text-right"},[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(materiel.cost))]),_vm._v(" "),_c('td',{staticClass:"text-right"},[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(_vm.formatNumber(materiel.cost * materiel.quantity, 2)))]),_vm._v(" "),_c('td',{staticClass:"text-right"},[_c('a',{staticClass:"btn btn-sm btn-danger",staticStyle:{"color":"#ffff"},attrs:{"title":"Delete"},on:{"click":function($event){return _vm.delete_materiel(materiel.product_id)}}},[_c('i',{staticClass:"i-Close-Window"})])])])})],2)])]),_vm._v(" "),_c('div',{staticClass:"offset-md-9 col-md-3 mt-4"},[_c('table',{staticClass:"table table-striped table-sm"},[_c('tbody',[_c('tr',[_c('td',[_vm._v("Total Cost")]),_vm._v(" "),_c('td',[_c('span',[_vm._v(_vm._s(_vm.currentUser.currency)+" "+_vm._s(_vm.formatNumber(_vm.totalCost, 2)))])])])])])])])],1):_vm._e(),_vm._v(" "),_c('b-card',{staticClass:"mt-3"},[_c('b-row',[(_vm.product.type == 'is_single')?_c('b-col',{staticClass:"mb-2 d-none",attrs:{"md":"6"}},[_c('b-form-group',{attrs:{"label":_vm.$t('type')}},[_c('b-form-input',{attrs:{"label":"Product Type","value":"Standard Product","disabled":"disabled"}})],1)],1):_vm._e(),_vm._v(" "),(_vm.product.type == 'is_combo')?_c('b-col',{staticClass:"mb-2 d-none",attrs:{"md":"6"}},[_c('b-form-group',{attrs:{"label":_vm.$t('type')}},[_c('b-form-input',{attrs:{"label":"Product Type","value":"Combo Product","disabled":"disabled"}})],1)],1):(_vm.product.type == 'is_service')?_c('b-col',{staticClass:"mb-2 d-none",attrs:{"md":"6"}},[_c('b-form-group',{attrs:{"label":_vm.$t('type')}},[_c('b-form-input',{attrs:{"label":"Product Type","value":"Service Product","disabled":"disabled"}})],1)],1):(_vm.product.type == 'is_variant')?_c('b-col',{staticClass:"mb-2 d-none",attrs:{"md":"6"}},[_c('b-form-group',{attrs:{"label":_vm.$t('type')}},[_c('b-form-input',{attrs:{"label":"Product Type","value":"Variable Product","disabled":"disabled"}})],1)],1):_vm._e(),_vm._v(" "),(_vm.product.type == 'is_single' || _vm.product.type == 'is_combo')?_c('b-col',{staticClass:"mb-2",attrs:{"md":"6"}},[_c('validation-provider',{attrs:{"name":"Product Cost","rules":{ required: true , regex: /^\d*\.?\d*$/}},scopedSlots:_vm._u([{key:"default",fn:function(validationContext){return [_c('b-form-group',{attrs:{"label":_vm.$t('ProductCost') + ' ' + '*'}},[_c('b-form-input',{attrs:{"state":_vm.getValidationState(validationContext),"aria-describedby":"ProductCost-feedback","label":"Cost","placeholder":_vm.$t('Enter_Product_Cost')},model:{value:(_vm.product.cost),callback:function ($$v) {_vm.$set(_vm.product, "cost", $$v)},expression:"product.cost"}}),_vm._v(" "),_c('b-form-invalid-feedback',{attrs:{"id":"ProductCost-feedback"}},[_vm._v(_vm._s(validationContext.errors[0]))])],1)]}}],null,false,3284448419)})],1):_vm._e(),_vm._v(" "),(_vm.product.type == 'is_single' || _vm.product.type == 'is_service' || _vm.product.type == 'is_combo')?_c('b-col',{staticClass:"mb-2",attrs:{"md":"6"}},[_c('validation-provider',{attrs:{"name":"Product Price","rules":{ required: true , regex: /^\d*\.?\d*$/}},scopedSlots:_vm._u([{key:"default",fn:function(validationContext){return [_c('b-form-group',{attrs:{"label":_vm.$t('ProductPrice') + ' ' + '*'}},[_c('b-form-input',{attrs:{"state":_vm.getValidationState(validationContext),"aria-describedby":"ProductPrice-feedback","label":"Price","placeholder":_vm.$t('Enter_Product_Price')},model:{value:(_vm.product.price),callback:function ($$v) {_vm.$set(_vm.product, "price", $$v)},expression:"product.price"}}),_vm._v(" "),_c('b-form-invalid-feedback',{attrs:{"id":"ProductPrice-feedback"}},[_vm._v(_vm._s(validationContext.errors[0]))])],1)]}}],null,false,566446563)})],1):_vm._e(),_vm._v(" "),(_vm.product.type != 'is_service')?_c('b-col',{staticClass:"mb-2",attrs:{"md":"6"}},[_c('validation-provider',{attrs:{"name":"Unit Product","rules":{ required: true}},scopedSlots:_vm._u([{key:"default",fn:function(ref){
                         var valid = ref.valid;
                         var errors = ref.errors;
return _c('b-form-group',{attrs:{"label":_vm.$t('UnitProduct') + ' ' + '*'}},[_c('div',{staticClass:"d-flex"},[_c('v-select',{staticClass:"required",class:{'is-invalid': !!errors.length},staticStyle:{"flex":"1"},attrs:{"state":errors[0] ? false : (valid ? true : null),"required":"","placeholder":_vm.$t('Choose_Unit_Product'),"reduce":function (label) { return label.value; },"options":_vm.units.map(function (units) { return ({label: units.name, value: units.id}); })},on:{"input":_vm.Selected_Unit},model:{value:(_vm.product.unit_id),callback:function ($$v) {_vm.$set(_vm.product, "unit_id", $$v)},expression:"product.unit_id"}}),_vm._v(" "),_c('b-button',{staticClass:"ml-2",staticStyle:{"height":"38px","min-width":"40px"},attrs:{"variant":"primary","size":"sm","title":"Ajouter une nouvelle unité"},on:{"click":function($event){return _vm.New_Unit()}}},[_c('i',{staticClass:"i-Add"})])],1),_vm._v(" "),_c('b-form-invalid-feedback',[_vm._v(_vm._s(errors[0]))])],1)}}],null,false,430830924)})],1):_vm._e(),_vm._v(" "),(_vm.product.type != 'is_service')?_c('b-col',{staticClass:"mb-2",attrs:{"md":"6"}},[_c('validation-provider',{attrs:{"name":"Unit Sale","rules":{ required: true}},scopedSlots:_vm._u([{key:"default",fn:function(ref){
                         var valid = ref.valid;
                         var errors = ref.errors;
return _c('b-form-group',{attrs:{"label":_vm.$t('UnitSale') + ' ' + '*'}},[_c('v-select',{class:{'is-invalid': !!errors.length},attrs:{"state":errors[0] ? false : (valid ? true : null),"placeholder":_vm.$t('Choose_Unit_Sale'),"reduce":function (label) { return label.value; },"options":_vm.units_sub.map(function (units_sub) { return ({label: units_sub.name, value: units_sub.id}); })},model:{value:(_vm.product.unit_sale_id),callback:function ($$v) {_vm.$set(_vm.product, "unit_sale_id", $$v)},expression:"product.unit_sale_id"}}),_vm._v(" "),_c('b-form-invalid-feedback',[_vm._v(_vm._s(errors[0]))])],1)}}],null,false,470125983)})],1):_vm._e(),_vm._v(" "),(_vm.product.type != 'is_service')?_c('b-col',{staticClass:"mb-2",attrs:{"md":"6"}},[_c('validation-provider',{attrs:{"name":"Unit Purchase","rules":{ required: true}},scopedSlots:_vm._u([{key:"default",fn:function(ref){
                         var valid = ref.valid;
                         var errors = ref.errors;
return _c('b-form-group',{attrs:{"label":_vm.$t('UnitPurchase') + ' ' + '*'}},[_c('v-select',{class:{'is-invalid': !!errors.length},attrs:{"state":errors[0] ? false : (valid ? true : null),"placeholder":_vm.$t('Choose_Unit_Purchase'),"reduce":function (label) { return label.value; },"options":_vm.units_sub.map(function (units_sub) { return ({label: units_sub.name, value: units_sub.id}); })},model:{value:(_vm.product.unit_purchase_id),callback:function ($$v) {_vm.$set(_vm.product, "unit_purchase_id", $$v)},expression:"product.unit_purchase_id"}}),_vm._v(" "),_c('b-form-invalid-feedback',[_vm._v(_vm._s(errors[0]))])],1)}}],null,false,2992180495)})],1):_vm._e(),_vm._v(" "),(_vm.product.type != 'is_service')?_c('b-col',{staticClass:"mb-2",attrs:{"md":"6"}},[_c('validation-provider',{attrs:{"name":"Stock Alert","rules":{ regex: /^\d*\.?\d*$/}},scopedSlots:_vm._u([{key:"default",fn:function(validationContext){return [_c('b-form-group',{attrs:{"label":_vm.$t('StockAlert')}},[_c('b-form-input',{attrs:{"state":_vm.getValidationState(validationContext),"aria-describedby":"StockAlert-feedback","label":"Stock alert","placeholder":_vm.$t('Enter_Stock_alert')},model:{value:(_vm.product.stock_alert),callback:function ($$v) {_vm.$set(_vm.product, "stock_alert", $$v)},expression:"product.stock_alert"}}),_vm._v(" "),_c('b-form-invalid-feedback',{attrs:{"id":"StockAlert-feedback"}},[_vm._v(_vm._s(validationContext.errors[0]))])],1)]}}],null,false,1999382198)})],1):_vm._e(),_vm._v(" "),(_vm.product.type == 'is_variant')?_c('div',{staticClass:"col-md-12 mb-3 mt-3"},[_c('div',{staticClass:"d-flex"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.tag),expression:"tag"}],staticClass:"form-control",staticStyle:{"height":"40px"},attrs:{"placeholder":"Enter the Variant","type":"text","name":"variant"},domProps:{"value":(_vm.tag)},on:{"input":function($event){if($event.target.composing){ return; }_vm.tag=$event.target.value}}}),_vm._v(" "),_c('a',{staticClass:"ms-3 btn btn-md btn-primary",staticStyle:{"color":"#ffff","margin-left":"10px"},on:{"click":function($event){return _vm.add_variant(_vm.tag)}}},[_vm._v(_vm._s(_vm.$t('Add')))])])]):_vm._e(),_vm._v(" "),(_vm.product.type == 'is_variant')?_c('div',{staticClass:"col-md-12 mb-2"},[_c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"table table-hover table-sm"},[_c('thead',{staticClass:"bg-gray-300"},[_c('tr',[_c('th',{attrs:{"scope":"col"}},[_vm._v(_vm._s(_vm.$t('Variant_code')))]),_vm._v(" "),_c('th',{attrs:{"scope":"col"}},[_vm._v(_vm._s(_vm.$t('Variant_Name')))]),_vm._v(" "),_c('th',{attrs:{"scope":"col"}},[_vm._v(_vm._s(_vm.$t('Variant_cost')))]),_vm._v(" "),_c('th',{attrs:{"scope":"col"}},[_vm._v(_vm._s(_vm.$t('Variant_price')))]),_vm._v(" "),_c('th',{attrs:{"scope":"col"}})])]),_vm._v(" "),_c('tbody',[(_vm.variants.length <=0)?_c('tr',[_c('td',{attrs:{"colspan":"3"}},[_vm._v(_vm._s(_vm.$t('NodataAvailable')))])]):_vm._e(),_vm._v(" "),_vm._l((_vm.variants),function(variant){return _c('tr',[_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:(variant.code),expression:"variant.code"}],staticClass:"form-control",attrs:{"required":""},domProps:{"value":(variant.code)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(variant, "code", $event.target.value)}}})]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:(variant.text),expression:"variant.text"}],staticClass:"form-control",attrs:{"required":""},domProps:{"value":(variant.text)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(variant, "text", $event.target.value)}}})]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:(variant.cost),expression:"variant.cost"}],staticClass:"form-control",attrs:{"required":""},domProps:{"value":(variant.cost)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(variant, "cost", $event.target.value)}}})]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:(variant.price),expression:"variant.price"}],staticClass:"form-control",attrs:{"required":""},domProps:{"value":(variant.price)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(variant, "price", $event.target.value)}}})]),_vm._v(" "),_c('td',[_c('a',{staticClass:"btn btn-sm btn-danger",staticStyle:{"color":"#ffff"},attrs:{"title":"Delete"},on:{"click":function($event){return _vm.delete_variant(variant.var_id)}}},[_c('i',{staticClass:"i-Close-Window"})])])])})],2)])])]):_vm._e()],1)],1),_vm._v(" "),_c('b-card',{staticClass:"mt-3",attrs:{"header":_vm.$t('Warranty_Guarantee_Tracking')}},[_c('b-row',[_c('b-col',{staticClass:"mb-2",attrs:{"md":"6"}},[_c('b-form-group',{attrs:{"label":_vm.$t('Warranty_Period')}},[_c('b-input-group',[_c('b-form-input',{attrs:{"placeholder":"0"},model:{value:(_vm.product.warranty_period),callback:function ($$v) {_vm.$set(_vm.product, "warranty_period", $$v)},expression:"product.warranty_period"}}),_vm._v(" "),_c('b-form-select',{attrs:{"options":[
                          { value: 'days', text: _vm.$t('Days') },
                          { value: 'months', text: _vm.$t('Months') },
                          { value: 'years', text: _vm.$t('Years') }
                        ]},model:{value:(_vm.product.warranty_unit),callback:function ($$v) {_vm.$set(_vm.product, "warranty_unit", $$v)},expression:"product.warranty_unit"}})],1)],1)],1),_vm._v(" "),_c('b-col',{staticClass:"mb-2",attrs:{"md":"12"}},[_c('b-form-group',{attrs:{"label":_vm.$t('WarrantyTerms')}},[_c('b-form-textarea',{attrs:{"placeholder":"Enter warranty terms...","rows":"3"},model:{value:(_vm.product.warranty_terms),callback:function ($$v) {_vm.$set(_vm.product, "warranty_terms", $$v)},expression:"product.warranty_terms"}})],1)],1),_vm._v(" "),_c('b-col',{staticClass:"mb-2",attrs:{"md":"6"}},[_c('b-form-group',[_c('b-form-checkbox',{attrs:{"name":"has_guarantee","unchecked-value":false,"checked-value":true},model:{value:(_vm.product.has_guarantee),callback:function ($$v) {_vm.$set(_vm.product, "has_guarantee", $$v)},expression:"product.has_guarantee"}},[_vm._v("\n                    "+_vm._s(_vm.$t('HasGuarantee'))+"\n                  ")])],1)],1),_vm._v(" "),(_vm.product.has_guarantee)?_c('b-col',{staticClass:"mb-2",attrs:{"md":"6"}},[_c('b-form-group',{attrs:{"label":_vm.$t('Guarantee_Period')}},[_c('b-input-group',[_c('b-form-input',{attrs:{"placeholder":"0"},model:{value:(_vm.product.guarantee_period),callback:function ($$v) {_vm.$set(_vm.product, "guarantee_period", $$v)},expression:"product.guarantee_period"}}),_vm._v(" "),_c('b-form-select',{attrs:{"options":[
                          { value: 'days', text: _vm.$t('Days') },
                          { value: 'months', text: _vm.$t('Months') },
                          { value: 'years', text: _vm.$t('Years') }
                        ]},model:{value:(_vm.product.guarantee_unit),callback:function ($$v) {_vm.$set(_vm.product, "guarantee_unit", $$v)},expression:"product.guarantee_unit"}})],1)],1)],1):_vm._e()],1)],1),_vm._v(" "),_c('b-card',{staticClass:"mt-3"},[_c('b-row',[_c('b-col',{attrs:{"md":"12 mb-2"}},[_c('ValidationProvider',{attrs:{"rules":"","vid":"product"},scopedSlots:_vm._u([{key:"default",fn:function(x){return [_c('div',{staticClass:"form-check"},[_c('label',{staticClass:"checkbox checkbox-outline-primary"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.product.is_imei),expression:"product.is_imei"}],attrs:{"type":"checkbox"},domProps:{"checked":Array.isArray(_vm.product.is_imei)?_vm._i(_vm.product.is_imei,null)>-1:(_vm.product.is_imei)},on:{"change":function($event){var $$a=_vm.product.is_imei,$$el=$event.target,$$c=$$el.checked?(true):(false);if(Array.isArray($$a)){var $$v=null,$$i=_vm._i($$a,$$v);if($$el.checked){$$i<0&&(_vm.$set(_vm.product, "is_imei", $$a.concat([$$v])))}else{$$i>-1&&(_vm.$set(_vm.product, "is_imei", $$a.slice(0,$$i).concat($$a.slice($$i+1))))}}else{_vm.$set(_vm.product, "is_imei", $$c)}}}}),_vm._v(" "),_c('h5',[_vm._v(_vm._s(_vm.$t('Product_Has_Imei_Serial_number')))]),_vm._v(" "),_c('span',{staticClass:"checkmark"})])])]}}],null,false,1678388961)})],1),_vm._v(" "),_c('b-col',{attrs:{"md":"12 mb-2"}},[_c('ValidationProvider',{attrs:{"rules":"","vid":"product"},scopedSlots:_vm._u([{key:"default",fn:function(x){return [_c('div',{staticClass:"form-check"},[_c('label',{staticClass:"checkbox checkbox-outline-primary"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.product.not_selling),expression:"product.not_selling"}],attrs:{"type":"checkbox"},domProps:{"checked":Array.isArray(_vm.product.not_selling)?_vm._i(_vm.product.not_selling,null)>-1:(_vm.product.not_selling)},on:{"change":function($event){var $$a=_vm.product.not_selling,$$el=$event.target,$$c=$$el.checked?(true):(false);if(Array.isArray($$a)){var $$v=null,$$i=_vm._i($$a,$$v);if($$el.checked){$$i<0&&(_vm.$set(_vm.product, "not_selling", $$a.concat([$$v])))}else{$$i>-1&&(_vm.$set(_vm.product, "not_selling", $$a.slice(0,$$i).concat($$a.slice($$i+1))))}}else{_vm.$set(_vm.product, "not_selling", $$c)}}}}),_vm._v(" "),_c('h5',[_vm._v(_vm._s(_vm.$t('This_Product_Not_For_Selling')))]),_vm._v(" "),_c('span',{staticClass:"checkmark"})])])]}}],null,false,2487563839)})],1)],1)],1)],1),_vm._v(" "),_c('b-col',{staticClass:"mt-3",attrs:{"md":"12"}},[_c('b-button',{attrs:{"variant":"primary","type":"submit","disabled":_vm.SubmitProcessing}},[_c('i',{staticClass:"i-Yes me-2 font-weight-bold"}),_vm._v(" "+_vm._s(_vm.$t('submit')))]),_vm._v(" "),(_vm.SubmitProcessing)?_vm._m(0):_vm._e()],1)],1)],1)],1):_vm._e(),_vm._v(" "),_c('validation-observer',{ref:"Create_Category"},[_c('b-modal',{attrs:{"hide-footer":"","size":"md","id":"New_Category","title":_vm.$t('Add') + ' ' + _vm.$t('Categorie')}},[_c('b-form',{on:{"submit":function($event){$event.preventDefault();return _vm.Submit_Category.apply(null, arguments)}}},[_c('b-row',[_c('b-col',{attrs:{"md":"12"}},[_c('validation-provider',{attrs:{"name":"Code category","rules":{ required: true}},scopedSlots:_vm._u([{key:"default",fn:function(validationContext){return [_c('b-form-group',{attrs:{"label":_vm.$t('Codecategorie') + ' ' + '*'}},[_c('b-form-input',{attrs:{"placeholder":_vm.$t('Enter_Code_category'),"state":_vm.getValidationState(validationContext),"aria-describedby":"Code-feedback","label":"Code"},model:{value:(_vm.newCategory.code),callback:function ($$v) {_vm.$set(_vm.newCategory, "code", $$v)},expression:"newCategory.code"}}),_vm._v(" "),_c('b-form-invalid-feedback',{attrs:{"id":"Code-feedback"}},[_vm._v(_vm._s(validationContext.errors[0]))])],1)]}}])})],1),_vm._v(" "),_c('b-col',{attrs:{"md":"12"}},[_c('validation-provider',{attrs:{"name":"Name category","rules":{ required: true}},scopedSlots:_vm._u([{key:"default",fn:function(validationContext){return [_c('b-form-group',{attrs:{"label":_vm.$t('Namecategorie') + ' ' + '*'}},[_c('b-form-input',{attrs:{"placeholder":_vm.$t('Enter_name_category'),"state":_vm.getValidationState(validationContext),"aria-describedby":"Name-feedback","label":"Name"},model:{value:(_vm.newCategory.name),callback:function ($$v) {_vm.$set(_vm.newCategory, "name", $$v)},expression:"newCategory.name"}}),_vm._v(" "),_c('b-form-invalid-feedback',{attrs:{"id":"Name-feedback"}},[_vm._v(_vm._s(validationContext.errors[0]))])],1)]}}])})],1),_vm._v(" "),_c('b-col',{staticClass:"mt-3",attrs:{"md":"12"}},[_c('b-button',{attrs:{"variant":"primary","type":"submit","disabled":_vm.CategorySubmitProcessing}},[_c('i',{staticClass:"i-Yes me-2 font-weight-bold"}),_vm._v(" "+_vm._s(_vm.$t('submit')))]),_vm._v(" "),(_vm.CategorySubmitProcessing)?_vm._m(1):_vm._e()],1)],1)],1)],1)],1),_vm._v(" "),_c('validation-observer',{ref:"Create_Unit"},[_c('b-modal',{attrs:{"hide-footer":"","size":"md","id":"New_Unit","title":_vm.$t('Add') + ' ' + _vm.$t('Units')}},[_c('b-form',{on:{"submit":function($event){$event.preventDefault();return _vm.Submit_Unit.apply(null, arguments)}}},[_c('b-row',[_c('b-col',{attrs:{"md":"12"}},[_c('validation-provider',{attrs:{"name":"Name","rules":{ required: true , max:15}},scopedSlots:_vm._u([{key:"default",fn:function(validationContext){return [_c('b-form-group',{attrs:{"label":_vm.$t('Name') + ' ' + '*'}},[_c('b-form-input',{attrs:{"placeholder":_vm.$t('Enter_Name_Unit'),"state":_vm.getValidationState(validationContext),"aria-describedby":"Name-feedback","label":"Name"},model:{value:(_vm.newUnit.name),callback:function ($$v) {_vm.$set(_vm.newUnit, "name", $$v)},expression:"newUnit.name"}}),_vm._v(" "),_c('b-form-invalid-feedback',{attrs:{"id":"Name-feedback"}},[_vm._v(_vm._s(validationContext.errors[0]))])],1)]}}])})],1),_vm._v(" "),_c('b-col',{attrs:{"md":"12"}},[_c('validation-provider',{attrs:{"name":"ShortName","rules":{ required: true , max:15}},scopedSlots:_vm._u([{key:"default",fn:function(validationContext){return [_c('b-form-group',{attrs:{"label":_vm.$t('ShortName') + ' ' + '*'}},[_c('b-form-input',{attrs:{"placeholder":_vm.$t('Enter_ShortName_Unit'),"state":_vm.getValidationState(validationContext),"aria-describedby":"ShortName-feedback","label":"ShortName"},model:{value:(_vm.newUnit.ShortName),callback:function ($$v) {_vm.$set(_vm.newUnit, "ShortName", $$v)},expression:"newUnit.ShortName"}}),_vm._v(" "),_c('b-form-invalid-feedback',{attrs:{"id":"ShortName-feedback"}},[_vm._v(_vm._s(validationContext.errors[0]))])],1)]}}])})],1),_vm._v(" "),_c('b-col',{attrs:{"md":"12"}},[_c('b-form-group',{attrs:{"label":_vm.$t('BaseUnit')}},[_c('v-select',{attrs:{"reduce":function (label) { return label.value; },"placeholder":_vm.$t('Choose_Base_Unit'),"options":_vm.units_base.map(function (units_base) { return ({label: units_base.name, value: units_base.id}); })},on:{"input":_vm.Selected_Base_Unit},model:{value:(_vm.newUnit.base_unit),callback:function ($$v) {_vm.$set(_vm.newUnit, "base_unit", $$v)},expression:"newUnit.base_unit"}})],1)],1),_vm._v(" "),_c('b-col',{directives:[{name:"show",rawName:"v-show",value:(_vm.show_operator),expression:"show_operator"}],attrs:{"md":"12"}},[_c('b-form-group',{attrs:{"label":_vm.$t('Operator')}},[_c('v-select',{attrs:{"reduce":function (label) { return label.value; },"placeholder":_vm.$t('Choose_Operator'),"options":[
                  {label: 'Multiply (*)', value: '*'},
                  {label: 'Divide (/)', value: '/'}
                ]},model:{value:(_vm.newUnit.operator),callback:function ($$v) {_vm.$set(_vm.newUnit, "operator", $$v)},expression:"newUnit.operator"}})],1)],1),_vm._v(" "),_c('b-col',{directives:[{name:"show",rawName:"v-show",value:(_vm.show_operator),expression:"show_operator"}],attrs:{"md":"12"}},[_c('validation-provider',{attrs:{"name":"Operation Value","rules":{ required: true , regex: /^\d*\.?\d*$/}},scopedSlots:_vm._u([{key:"default",fn:function(validationContext){return [_c('b-form-group',{attrs:{"label":_vm.$t('OperationValue') + ' ' + '*'}},[_c('b-form-input',{attrs:{"placeholder":_vm.$t('Enter_Operation_Value'),"state":_vm.getValidationState(validationContext),"aria-describedby":"Operation-feedback","label":"Operation"},model:{value:(_vm.newUnit.operator_value),callback:function ($$v) {_vm.$set(_vm.newUnit, "operator_value", $$v)},expression:"newUnit.operator_value"}}),_vm._v(" "),_c('b-form-invalid-feedback',{attrs:{"id":"Operation-feedback"}},[_vm._v(_vm._s(validationContext.errors[0]))])],1)]}}])})],1),_vm._v(" "),_c('b-col',{staticClass:"mt-3",attrs:{"md":"12"}},[_c('b-button',{attrs:{"variant":"primary","type":"submit","disabled":_vm.UnitSubmitProcessing}},[_c('i',{staticClass:"i-Yes me-2 font-weight-bold"}),_vm._v(" "+_vm._s(_vm.$t('submit')))]),_vm._v(" "),(_vm.UnitSubmitProcessing)?_vm._m(2):_vm._e()],1)],1)],1)],1)],1)],1)}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_product_vue_vue_type_template_id_379e8f98__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_product_vue_vue_type_template_id_379e8f98__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_product_vue_vue_type_template_id_379e8f98__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Edit_product.vue?vue&type=template&id=379e8f98 */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/products/Edit_product.vue?vue&type=template&id=379e8f98");
