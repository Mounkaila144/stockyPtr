...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"main-content"},[_c('breadcumb',{attrs:{"page":_vm.$t('Brand'),"folder":_vm.$t('Products')}}),_vm._v(" "),(_vm.isLoading)?_c('div',{staticClass:"loading_page spinner spinner-primary mr-3"}):_vm._e(),_vm._v(" "),(!_vm.isLoading)?_c('b-card',{staticClass:"wrapper"},[_c('vue-good-table',{attrs:{"mode":"remote","columns":_vm.columns,"totalRows":_vm.totalRows,"rows":_vm.brands,"search-options":{
      ...
      nextLabel: 'next',
      prevLabel: 'prev',
    },"styleClass":"table-hover tableOne vgt-table"},on:{"on-page-change":_vm.onPageChange,"on-per-page-change":_vm.onPerPageChange,"on-sort-change":_vm.onSortChange,"on-search":_vm.onSearch,"on-selected-rows-change":_vm.selectionChanged},scopedSlots:_vm._u([{key:"table-row",fn:function(props){return [(props.column.field == 'actions')?_c('span',[_c('a',{directives:[{name:"b-tooltip",rawName:"v-b-tooltip.hover",modifiers:{"hover":true}}],attrs:{"title":"Edit"},on:{"click":function($event){return _vm.Edit_Brand(props.row)}}},[_c('i',{staticClass:"i-Edit text-25 text-success"})]),_vm._v(" "),_c('a',{directives:[{name:"b-tooltip",rawName:"v-b-tooltip.hover",modifiers:{"hover":true}}],attrs:{"title":"Delete"},on:{"click":function($event){return _vm.Delete_Brand(props.row.id)}}},[_c('i',{staticClass:"i-Close-Window text-25 text-danger"})])]):(props.column.field == 'image')?_c('span',[_c('b-img',{attrs:{"thumbnail":"","height":"50","width":"50","fluid":"","src":'/images/brands/' + props.row.image,"alt":"image"}})],1):_vm._e()]}}],null,false,545511441)},[_c('div',{attrs:{"slot":"selected-row-actions"},slot:"selected-row-actions"},[_c('button',{staticClass:"btn btn-danger btn-sm",on:{"click":function($event){return _vm.delete_by_selected()}}},[_vm._v(_vm._s(_vm.$t('Del')))])]),_vm._v(" "),_c('div',{staticClass:"mt-2 mb-3",attrs:{"slot":"table-actions"},slot:"table-actions"},[_c('b-button',{staticClass:"btn-rounded",attrs:{"variant":"btn btn-primary btn-icon m-1"},on:{"click":function($event){return _vm.New_Brand()}}},[_c('i',{staticClass:"i-Add"}),_vm._v("\n          "+_vm._s(_vm.$t('Add'))+"\n        ")])],1)])],1):_vm._e(),_vm._v(" "),_c('validation-observer',{ref:"Create_brand"},[_c('b-modal',{attrs:{"hide-footer":"","size":"md","id":"New_brand","title":_vm.editmode?_vm.$t('Edit'):_vm.$t('Add')}},[_c('b-form',{attrs:{"enctype":"multipart/form-data"},on:{"submit":function($event){$event.preventDefault();return _vm.Submit_Brand.apply(null, arguments)}}},[_c('b-row',[_c('b-col',{attrs:{"md":"12"}},[_c('validation-provider',{attrs:{"name":"Brand Name","rules":{ required: true , min:3 , max:20}},scopedSlots:_vm._u([{key:"default",fn:function(validationContext){return [_c('b-form-group',{attrs:{"label":_vm.$t('BrandName') + ' ' + '*'}},[_c('b-form-input',{attrs:{"placeholder":_vm.$t('Enter_Name_Brand'),"state":_vm.getValidationState(validationContext),"aria-describedby":"Name-feedback","label":"Name"},model:{value:(_vm.brand.name),callback:function ($$v) {_vm.$set(_vm.brand, "name", $$v)},expression:"brand.name"}}),_vm._v(" "),_c('b-form-invalid-feedback',{attrs:{"id":"Name-feedback"}},[_vm._v(_vm._s(validationContext.errors[0]))])],1)]}}])})],1),_vm._v(" "),_c('b-col',{attrs:{"md":"12"}},[_c('validation-provider',{attrs:{"name":"Brand Description","rules":{ max:30}},scopedSlots:_vm._u([{key:"default",fn:function(validationContext){return [_c('b-form-group',{attrs:{"label":_vm.$t('BrandDescription')}},[_c('b-form-textarea',{attrs:{"rows":"3","placeholder":_vm.$t('Enter_Description_Brand'),"state":_vm.getValidationState(validationContext),"aria-describedby":"Description-feedback","label":"Description"},model:{value:(_vm.brand.description),callback:function ($$v) {_vm.$set(_vm.brand, "description", $$v)},expression:"brand.description"}}),_vm._v(" "),_c('b-form-invalid-feedback',{attrs:{"id":"Description-feedback"}},[_vm._v(_vm._s(validationContext.errors[0]))])],1)]}}])})],1),_vm._v(" "),_c('b-col',{attrs:{"md":"12"}},[_c('validation-provider',{ref:"Image",attrs:{"name":"Image","rules":"mimes:image/*|size:200"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
    var validate = ref.validate;
    var valid = ref.valid;
    var errors = ref.errors;
return _c('b-form-group',{attrs:{"label":_vm.$t('BrandImage')}},[_c('input',{class:{'is-invalid': !!errors.length},attrs:{"state":errors[0] ? false : (valid ? true : null),"label":"Choose Image","type":"file"},on:{"change":_vm.onFileSelected}}),_vm._v(" "),_c('b-form-invalid-feedback',{attrs:{"id":"Image-feedback"}},[_vm._v(_vm._s(errors[0]))])],1)}}])})],1),_vm._v(" "),_c('b-col',{staticClass:"mt-3",attrs:{"md":"12"}},[_c('b-button',{attrs:{"variant":"primary","type":"submit","disabled":_vm.SubmitProcessing}},[_c('i',{staticClass:"i-Yes me-2 font-weight-bold"}),_vm._v(" "+_vm._s(_vm.$t('submit')))]),_vm._v(" "),(_vm.SubmitProcessing)?_vm._m(0):_vm._e()],1)],1)],1)],1)],1)],1)}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_brands_vue_vue_type_template_id_495bf50a__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_brands_vue_vue_type_template_id_495bf50a__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_brands_vue_vue_type_template_id_495bf50a__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./brands.vue?vue&type=template&id=495bf50a */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/products/brands.vue?vue&type=template&id=495bf50a");
